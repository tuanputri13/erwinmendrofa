...
function SectionLabel({
  ...
  return (
    <div className="mb-4 flex items-center gap-3 font-mono text-xs uppercase tracking-[0.22em] text-cyan-400">
      <span className="text-slate-600">{number}</span>
      <span>{children}</span>
      <span className="h-px w-10 bg-cyan-500/30" />
    </div>
  );
}
...
const skillGroups = [
  {
    ...
    description:
      "Routing & switching, network troubleshooting, infrastructure lapangan, serta lingkungan VSAT.",
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#020617] text-slate-100 selection:bg-cyan-400 selection:text-slate-950">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/2 top-[-18rem] h-[40rem] w-[70rem] -translate-x-1/2 rounded-full bg-cyan-500/[0.07] blur-3xl" />
        <div className="absolute right-[-15rem] top-[30rem] h-[35rem] w-[35rem] rounded-full bg-blue-600/[0.05] blur-3xl" />
      ...
      >
        <div className="mx-auto grid w-full max-w-[1500px] grid-cols-1 gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[1.15fr_0.85fr] lg:gap-20 lg:px-12 xl:py-24">
          {/* LEFT */}
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-5xl text-5xl font-black leading-[0.95] tracking-[-0.045em] text-white sm:text-6xl md:text-7xl xl:text-[6.3rem]">
              Erwin Setiawan{" "}
      ...
      >
        <div className="mx-auto w-full max-w-[1500px] px-5 py-24 sm:px-8 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
            <div>
              <SectionLabel number="01">Peran & Kapabilitas</SectionLabel>
        ...
        <div className="mx-auto w-full max-w-[1500px] px-5 py-24 sm:px-8 lg:px-12">
          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            ...
            <p className="max-w-xl text-sm leading-7 text-slate-500">
              Area di bawah ini menggambarkan bidang teknologi yang menjadi
              bagian dari eksplorasi dan pekerjaan saya.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2">
            {skillGroups.map((skill) => {
              ...
              return (
                <article
                  key={skill.title}
                  className="group rounded-2xl border border-slate-800 bg-slate-950/60 p-6 sm:p-8 transition hover:border-slate-700"
                >
      ...
      >
        <div className="mx-auto w-full max-w-[1500px] px-5 py-24 sm:px-8 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
            <div>
              <SectionLabel number="03">Cara Saya Bekerja</SectionLabel>

              <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl">
                Bukan hanya{" "}
                <span className="text-cyan-400">menggunakan teknologi.</span>
              </h2>

              <p className="mt-6 text-sm leading-7 text-slate-500 sm:text-base">
                Pendekatan saya berangkat dari kebutuhan atau masalah,
                kemudian memilih teknologi yang masuk akal untuk menyelesaikan
                masalah tersebut.
              </p>
            </div>
          ...
          <div className="grid gap-14 lg:grid-cols-[1fr_1fr] lg:gap-24">
            ...
            <div className="space-y-6 text-sm leading-7 text-slate-400 sm:text-base">
              <p>
                ...
                dari berbagai sisi: mulai dari konektivitas dan infrastruktur,
              ...
              <p>
                ...
                berbeda: teknologi bukan hanya perlu dibuat, tetapi juga perlu
                dipahami dan dapat dibagikan kepada orang lain.
              </p>
            ...
            <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
              <div>
                ...
                <h2 className="max-w-3xl text-3xl font-black tracking-tight text-white sm:text-5xl">
                  Punya project, ide, atau masalah teknis yang ingin dibahas?
                </h2>

                <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-400 sm:text-base">
                  Saya terbuka untuk diskusi mengenai infrastruktur jaringan,
                  pengembangan sistem, teknologi pendidikan, elektronika, dan
      ...
      <footer className="border-t border-slate-900">
        <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-4 px-5 py-8 sm:px-8 md:flex-row md:items-center md:justify-between lg:px-12">
          <div>
